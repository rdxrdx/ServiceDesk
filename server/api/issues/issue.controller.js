...
var mailOptions = {
                ...
                //   MAIL_CONFIRMATION_TOKEN : mailConfirmationToken,
                    ...
                    '<img src="http://www.pnet.co.za/upload_za/logo/S/logoSkhomo-Technologies-18249ZEN.gif" alt="" with="250">' +
                    ...
                    '<div style="margin: 5;color: #60666d;font-size: 50px;font-family: sans-serif;line-height: 20px; text-align: left;">' +
                                                                                                    '<div class="bottom-padding" style="margin-bottom: 10px; line-height: 15px; font-size: 15px;">&nbsp;</div>' +
                                                                                                    '<div style="text-align: center; margin: 5; font-size: 10px;  text-transform: uppercase; letter-spacing: .5px;">Rating (select a star amount):</div>' +
                                                                                                    '<div style="text-align: center; margin: 5; font-size: 10px;  text-transform: uppercase; letter-spacing: .5px;"><p>Overrall how Dissatisfied or Satisfied are you with the system</p><input type="radio" name="sname" value="sname"/>Very Satisfying<input type="radio" name="sname" value="sname"/>Somewhat Satisfying<input type="radio" name="sname" value="sname"/>Very Dissatisfied<input type="radio" name="sname" value="sname"/>Neutral<input type="radio" name="sname" value="sname"/>Bad<input type="radio" name="sname" value="sname"/>Worse</div>' +
                                                                                                    '<div style="text-align: center; margin: 5; font-size: 10px;  text-transform: uppercase; letter-spacing: .5px;"><p>Overrall how Dissatisfied or Satisfied are you with the system</p><input type="radio" name="sname" value="sname"/>Very Satisfying<input type="radio" name="sname" value="sname"/>Somewhat Satisfying<input type="radio" name="sname" value="sname"/>Very Dissatisfied<input type="radio" name="sname" value="sname"/>Neutral<input type="radio" name="sname" value="sname"/>Bad<input type="radio" name="sname" value="sname"/>Worse</div>' +
                                                                                                    '<div style="text-align: center; margin: 5; font-size: 10px;  text-transform: uppercase; letter-spacing: .5px;"><p>Overrall how Dissatisfied or Satisfied are you with the system</p><input type="radio" name="sname" value="sname"/>Very Satisfying<input type="radio" name="sname" value="sname"/>Somewhat Satisfying<input type="radio" name="sname" value="sname"/>Very Dissatisfied<input type="radio" name="sname" value="sname"/>Neutral<input type="radio" name="sname" value="sname"/>Bad<input type="radio" name="sname" value="sname"/>Worse</div>' +
                                                                                                    '<div style="text-align: center; margin: 5; font-size: 10px;  text-transform: uppercase; letter-spacing: .5px;"><p>Overrall how Dissatisfied or Satisfied are you with the system</p><input type="radio" name="sname" value="sname"/>Very Satisfying<input type="radio" name="sname" value="sname"/>Somewhat Satisfying<input type="radio" name="sname" value="sname"/>Very Dissatisfied<input type="radio" name="sname" value="sname"/>Neutral<input type="radio" name="sname" value="sname"/>Bad<input type="radio" name="sname" value="sname"/>Worse</div>' +
                                                                                                    '<div style="text-align: center; margin: 5; font-size: 10px;  text-transform: uppercase; letter-spacing: .5px;"><p>Overrall how Dissatisfied or Satisfied are you with the system</p><input type="radio" name="sname" value="sname"/>Very Satisfying<input type="radio" name="sname" value="sname"/>Somewhat Satisfying<input type="radio" name="sname" value="sname"/>Very Dissatisfied<input type="radio" name="sname" value="sname"/>Neutral<input type="radio" name="sname" value="sname"/>Bad<input type="radio" name="sname" value="sname"/>Worse</div>' +

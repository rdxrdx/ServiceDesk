...
function createLNodeObject(type, native, state) {
    return { native: /** @type {?} */ (native), data: state, dynamicLContainerNode: null };
}
/**
 * @param {?} index
 * @param {?} type
...
function createNodeAtIndex(index, type, native, name, attrs, state) {
    ...
    /** @type {?} */
    const node = createLNodeObject(type, native, isState ? /** @type {?} */ (state) : null);
    /** @type {?} */
    let tNode;
...
function directiveCreate(directiveDefIdx, directive, directiveDef) {
    ...
    if ((/** @type {?} */ (directiveDef)).template) {
        /** @type {?} */ ((hostNode.data))[CONTEXT] = directive;
    }
    if (firstTemplatePass) {
...
function addComponentLogic(def) {
    ...
    /** @type {?} */
    const componentView = addToViewTree(viewData, /** @type {?} */ (previousOrParentTNode.index), createLViewData(rendererFactory.createRenderer(/** @type {?} */ (hostNode.native), def), tView, null, def.onPush ? 4 /* Dirty */ : 2 /* CheckAlways */, getCurrentSanitizer()));
    // We need to set the host node/data here because when the component LNode was created,
    // we didn't yet know it was a component (just an element).
    (/** @type {?} */ (hostNode)).data = componentView;
    (/** @type {?} */ (componentView))[HOST_NODE] = /** @type {?} */ (previousOrParentTNode);
    if (firstTemplatePass) {
...
function createTemplateRef(TemplateRefToken, ElementRefToken, hostTNode, hostView) {
    if (!R3TemplateRef) {
        ...
        R3TemplateRef = class TemplateRef_ extends TemplateRefToken {
             ...
             * @return {?}
             */
            createEmbeddedView(context, container$$1, tContainerNode, hostView, index) {
                /** @type {?} */
                ...
                if (container$$1) {
                    insertView(lView, container$$1, /** @type {?} */ ((hostView)), /** @type {?} */ ((index)), /** @type {?} */ ((/** @type {?} */ ((tContainerNode)).parent)).index);
                }
    ...
    if (!R3ViewContainerRef) {
        ...
        R3ViewContainerRef = class ViewContainerRef_ extends ViewContainerRefToken {
            ...
            insert(viewRef, index) {
                ...
                /** @type {?} */
                const container$$1 = /** @type {?} */ ((this._getHostNode().dynamicLContainerNode));
                /** @type {?} */
                const beforeNode = getBeforeNodeForView(adjustedIdx, this._lContainer[VIEWS], container$$1);
    ...
    for (let i = 0; i < instructions.length; i++) {
        ...
        switch (instruction & -536870912 /* InstructionMask */) {
            case 1073741824 /* Element */:
                ...
                /** @type {?} */
                const element$$1 = load(elementIndex);
                /** @type {?} */

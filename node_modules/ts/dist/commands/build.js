...
function run(cli) {
    return __awaiter(this, void 0, void 0, function () {
        var packageJsonData, tsconfigJsonPath, tsconfigJsonData, _a, options, compilerOptionsJson, compilerOptions, globs, filePaths, startingTime, _b, diagnostics, result;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 5:
                    ...
                    _c.label = 6;
                case 6:
                    globs = sources_1.getSourceGlobs(cli.input, options).concat(sources_1.getAlwaysIncludeGlobs(options));
                    return [4 /*yield*/, sources_1.resolveGlobs(globs)];
                case 7:
                    filePaths = _c.sent();
                    ...
                    _b = compiler_1.compileOnce(filePaths, compilerOptions), diagnostics = _b.diagnostics, result = _b.result;

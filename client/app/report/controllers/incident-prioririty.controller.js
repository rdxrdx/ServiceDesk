                  ...
                  $scope.issues = issues;
                   ...
                   for (var i = 0; i < issues.length; i++) {
                       var status = itemIds[i].issueStatus.issueStatusName;
                         ...
                         $scope.issues[i].duration = $scope.resolutionTime($scope.issues[i].added).toFixed(2);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    $scope.getValues = function() {
        var labs = ['New','Approved','Rejected','closed'];
        var ourData = [];
    ...
    $scope.resolutionTime = function (modified) {
        var now = moment(new Date()); //todays date
        var duration = moment.duration(now.diff(modified));
